...
if(childrenArr && childrenArr != undefined  && childrenArr != "" ){
    for (var i = 0; i < childrenArr.length; i++) {

      if (childrenArr[i].CHILD_COUNT !== "0" && childrenArr[i].children &&  childrenArr[i].children != undefined &&  childrenArr[i].children != "") {
        this.treeItems +=
          `<li class="nav-link">` +
