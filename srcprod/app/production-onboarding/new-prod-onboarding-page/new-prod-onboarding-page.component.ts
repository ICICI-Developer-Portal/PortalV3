...
@Component({
  selector: 'app-new-prod-onboarding-page',
  templateUrl: './new-prod-onboarding-page.component.html',
  styleUrls: ['./new-prod-onboarding-page.component.css']
})
export class NewProdOnboardingPageComponent implements OnInit {
