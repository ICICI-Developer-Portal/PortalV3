...
import { DiyMerchantOnboardingComponent } from './diy-merchant-onboarding/diy-merchant-onboarding.component';
import { DiyMerchantOnboardingRequestComponent } from './diy-merchant-onboarding-request/diy-merchant-onboarding-request.component';
import { DiyOnboardingRequestComponent } from './diy-onboarding-request/diy-onboarding-request.component';
...
const routes: Routes = [
  ...
  /*   { path: 'userprofile', component: UserprofileComponent ,canActivate: [AuthGuard]}, */
    ...
    { path: 'DiyMerchantOnboarding', component: DiyMerchantOnboardingComponent ,canActivate: [AuthGuard]},
    { path: 'DiyMerchantOnboardingRequest', component: DiyMerchantOnboardingRequestComponent ,canActivate: [AuthGuard]},
    { path: 'DiyOnboardingRequest', component: DiyOnboardingRequestComponent ,canActivate: [AuthGuard]},
