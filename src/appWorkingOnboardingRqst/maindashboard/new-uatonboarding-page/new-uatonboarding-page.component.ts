...
@Component({
  selector: 'app-new-uatonboarding-page',
  templateUrl: './new-uatonboarding-page.component.html',
  styleUrls: ['./new-uatonboarding-page.component.css']
})
export class NewUatonboardingPageComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  onClickContinueBtn() {
    ...
    this.adm.getUATFromData(json).subscribe((data: any) => {
      localStorage.removeItem('additonalFields')
      console.log(data);
  ...
  // "IP", "Port", "Account Number", "Client Code", "URL", "Checksum", "Encryption", "Certificate", "Service Type", "Communication Method", "IFSC Code", "Virtual Code", "IPS Refund Code", "Intermediate Account Number", "Account Name", "Authorization Level", "URN", "Environment", "Validation Mode", "Acceptance Mode", "Recipient Mail ID", "Mode Offered", "Transaction Limit", "API Name", "Headers", "TestingID"
      ...
      //     var obj = {
      //       ID: "1229",
      //      ADDITIONAL_DETAILS: "Account Number,Account Name,URL,Client Code,IP,Port,EmpID,SOLID", 
  ...
  multipleSelectAPI(e, isChecked: boolean) {
   // this.forResetiingAdditionalFields();
    ...
    this.forResetiingAdditionalFields();
          ...
          $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", true)
          $(".input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", true)

        }
        //alert($(".customcsscontainer input:checkbox:checked").attr('selectAlldomainName'))
        //alert($(".customcsscontainer input:checkbox:checked").attr('class'))
        // alert($(".scndCheckbox input:checkbox:checked").attr('selectAlldomainName'))
        if (($(".scndCheckbox input:checkbox:checked").attr('selectAlldomainName') != e.target.getAttribute('selectAlldomainName')) && $(".scndCheckbox input:checkbox:checked").length > 0) {
          // alert("1 1")
    this.forResetiingAdditionalFields();
          ...
          this.selectedAPINAME = [];
          this.selectedValue = [];
          $(".scndCheckbox input:checkbox:checked").attr('selectAlldomainName')
          $(".customcsscontainer input:checkbox").attr("checked", false)
          $(".customcsscontainer input:checkbox").removeAttr("checked")
          $(".customcsscontainer input:checkbox").prop("checked", false)
          $('.ContinueBtn').prop('disabled', false);
          $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", false)
        ...
        var selectedheckboxes = document.querySelectorAll("input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']:checked")
        for (var i = 0; i < selectedheckboxes.length; i++) {
          if (selectedheckboxes[i].getAttribute('class') != "selectAll") {
            this.selectedValue.push({
              "selectalldomainname": e.target.getAttribute('selectalldomainname'),
        ...
        this.selectedValue = [];
        $(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").removeAttr("checked")
        $(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", false)
        $(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").removeAttr("checked")
        $(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").prop("checked", false)
    ...
    //logic for multiple select
      ...
      if ($(".customcsscontainer input:checkbox:checked").length) {
        ...
        console.log($(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").length)
        console.log($(".customcsscontainer input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']:checkbox:checked").length)
      ...
      if ($(".scndCheckbox input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").length == $(".scndCheckbox input[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']:checkbox:checked").length) {
        //  $(".selectAll[selectAlldomainName='"+e.target.getAttribute('selectAlldomainName')+"']").addAttr("checked");
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", true)
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").prop("checked", true)
      }
      else {
        // //alert("hii")
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").removeAttr("checked");
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").attr("checked", false)
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").removeAttr("checked")
        $(".selectAll[selectAlldomainName='" + e.target.getAttribute('selectAlldomainName') + "']").prop("checked", false)
        //  $('.ContinueBtn').prop('disabled', true);
      ...
      if (isChecked) {
        ...
        if (this.selectedValue.length > 0) {
          ...
          if ((this.selectedValue[0]['selectalldomainname'] != e.target.getAttribute('selectalldomainname')) ) {
  ...
  onSubmitUATForm(Prodconfirm) {
    ...
    let inputFields = {
      ...
      Encryption: reactiveFromFieldValues.whitelistIpSection.Encryption ? reactiveFromFieldValues.whitelistIpSection.Encryption.value : '',
      ...
      Acc_SOLID: reactiveFromFieldValues.whitelistIpSection.SOLID ? reactiveFromFieldValues.whitelistIpSection.SOLID : '',
      acc_EmpID: reactiveFromFieldValues.whitelistIpSection.EmpID ? reactiveFromFieldValues.whitelistIpSection.EmpID : '',
    ...
    if (extention.toLowerCase() == "zip") {
      ...
      this.HttpClient.post<any>(
        ...
        "https://developer.icicibank.com/rest/create-jira-new-uat1",
        ...
        res => {
          ...
          } else if ((res.status == false || res.status == "false") && res.status_code == 221) {
