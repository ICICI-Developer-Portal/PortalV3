...
this.fetchedMerchantName=obj[0]["MerchantName"];
this.fetchedDescription=obj[0]["Description"];
this.fetchedSpocEmail=obj[0]["SpocEmail"];
this.fetchedSpocPhone=obj[0]["SpocPhone"];
...
this.reactiveForm.controls.nestedCheckboxesList.patchValue({
  "domain" :this.fetchedDomain,
  "domainApi" :domainApiName
});
